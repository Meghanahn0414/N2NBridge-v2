...
const ROLES = [
  ...
  },
  {
    ...
    headline: "Every voice,one bridge.",
    blurb: "See what your constituents need, track your team's progress, and close the loop with everyone who reached out.",
    points: ["Review your constituency's priority queue", "Assign and reassign cases to staff", "Reply to constituents in one thread"],
    idLabel: "Email",
    idPlaceholder: "Enter Email Address",
    cta: "Sign in",
    note: "",
