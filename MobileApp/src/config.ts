...
// see services/lookupApi.ts, which link-representative.tsx already uses).
...
// MONGODB_URL each) — see Backend/LookupService and utils/lookup_client.py.
export const LOOKUP_BASE =
  process.env.EXPO_PUBLIC_LOOKUP_URL?.replace(/\/$/, "") || "";
