...
export default function AdminProfile() {
  ...
  const initials = (profile?.fullName || user?.name || "A")
  ...
  return (
    ...
    >
      ...
      <View style={styles.card}>
        ...
        <MenuRow icon="📋" label="All Grievances" onPress={() => router.push("/admin/grievances" as any)} />
        <MenuRow icon="👥" label="Citizens List" onPress={() => router.push("/admin/citizens" as any)} />
      </View>
      ...
      <Text style={styles.version}>Jan Seva CRM · Admin App</Text>
    </ScrollView>
  );
}
...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: "#7C3AED", paddingTop: 56, paddingBottom: 32, alignItems: "center" },
  avatarCircle: {
