...
export default function MlaComplaints() {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerTitle}>Constituency Complaints</Text>
          ...
          items.map((g) => {
            ...
            return (
              <View key={g.id} style={styles.card}>
                ...
                {g.citizenName && <Text style={styles.cardSub}>👤 {g.citizenName}</Text>}
...
const styles = StyleSheet.create({
  ...
  tag: { fontSize: 11, color: "#059669", backgroundColor: "#ECFDF5", borderRadius: 6, paddingHorizontal: 8, paddingVertical: 2 },
